...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU_MIO_TREE_PERIPHERALS {UART 1#UART 1#UART 0#UART 0#I2C 1#I2C 1#SPI 1#GPIO0 MIO#GPIO0 MIO#SPI 1#SPI 1#SPI 1#GPIO0 MIO#SD 0#SD 0#SD 0#SD 0#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#SD 0#SD 0#GPIO0 MIO#SD 0#GPIO0 MIO#PMU GPI 0#DPAUX#DPAUX#DPAUX#DPAUX##PMU GPO 0#PMU GPO 1#PMU GPO 2####SPI 0###SPI 0#SPI 0#SPI 0###SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 1#USB 1#USB 1#USB 1#USB 1#USB 1#USB 1#USB 1#USB 1#USB 1#USB 1#USB 1##} \
...
#### Create IP（USE IP WINDOW => CATALOG's infomation）
...
set_property -dict [ list CONFIG.NUM_MI {3} CONFIG.NUM_SI {2} ] $axi_interconnect_1
# Create instance: proc_sys_reset, and set properties
set proc_sys_reset [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 proc_sys_reset ]
# Create instance: uart16550
set axi_uart16550_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_uart16550:2.0 axi_uart16550_0]


##### Create interface connections(Master & Slave connections)
...
connect_bd_intf_net -intf_net axi_interconnect_1_m00_axi [get_bd_intf_pins axi_uart16550_0/S_AXI] [get_bd_intf_pins axi_interconnect_1/M00_AXI]
...
connect_bd_intf_net -intf_net axi_interconnect_1_m02_axi [get_bd_intf_pins HLS_accel_1/s_axi_CONTROL_BUS] [get_bd_intf_pins axi_interconnect_1/M02_AXI]
...
connect_bd_intf_net -intf_net ultra_ps_m_axi_fpd [get_bd_intf_pins axi_interconnect_1/S00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_LPD]
connect_bd_intf_net -intf_net ultra_ps_m_axi_lpd [get_bd_intf_pins axi_interconnect_1/S01_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_FPD]
connect_bd_intf_net -intf_net ultra_ps_s_axi_fpd [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HPC0_FPD]
# connetct pin with port
connect_bd_intf_net -intf_net zynq_ultra_ps_gpio [get_bd_intf_pins zynq_ultra_ps_e_0/GPIO_0] [get_bd_intf_ports GPIO_SENSORS]
connect_bd_intf_net -intf_net zynq_ultra_ps_uart1 [get_bd_intf_pins zynq_ultra_ps_e_0/UART_1] [get_bd_intf_ports UART1]
# create port of OUTPUT pins
create_bd_port -dir O BT_rtsn
connect_bd_net [get_bd_pins /zynq_ultra_ps_e_0/emio_uart0_rtsn] [get_bd_ports BT_rtsn]
# create port of INPUT pins
create_bd_port -dir I BT_ctsn
connect_bd_net [get_bd_pins /zynq_ultra_ps_e_0/emio_uart0_ctsn] [get_bd_ports BT_ctsn]
# create port of axi_uart16550_0 and connect pins
create_bd_port -dir I UART0_ctsn
connect_bd_net [get_bd_pins /axi_uart16550_0/ctsn] [get_bd_ports UART0_ctsn]
create_bd_port -dir O UART0_rtsn
connect_bd_net [get_bd_pins /axi_uart16550_0/rtsn] [get_bd_ports UART0_rtsn]
create_bd_port -dir I UART0_rxd
connect_bd_net [get_bd_pins /axi_uart16550_0/sin] [get_bd_ports UART0_rxd]
create_bd_port -dir O UART0_txd
connect_bd_net [get_bd_pins /axi_uart16550_0/sout] [get_bd_ports UART0_txd]
  
# Create port connections
connect_bd_net -net processing_system7_1_fclk_clk0 [get_bd_pins HLS_accel_1/ap_clk] [get_bd_pins axi_dma_1/m_axi_mm2s_aclk] [get_bd_pins axi_dma_1/m_axi_s2mm_aclk] [get_bd_pins axi_dma_1/s_axi_lite_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/M01_ACLK] [get_bd_pins axi_interconnect_1/M02_ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins axi_interconnect_1/S01_ACLK] [get_bd_pins axi_uart16550_0/s_axi_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihpc0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins proc_sys_reset/slowest_sync_clk]
...
connect_bd_net -net proc_sys_reset_peripheral_aresetn [get_bd_pins HLS_accel_1/ap_rst_n] [get_bd_pins axi_uart16550_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/M01_ARESETN] [get_bd_pins axi_interconnect_1/S01_ARESETN] [get_bd_pins axi_interconnect_1/M02_ARESETN] [get_bd_pins proc_sys_reset/peripheral_aresetn]
connect_bd_net -net proc_sys_reset_ext_reset_in [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0] [get_bd_pins proc_sys_reset/ext_reset_in]
connect_bd_net -net zynq_ultra_pl_ps_irq0 [get_bd_pins axi_uart16550_0/ip2intc_irpt] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]

# => [Auto Address Design] => [Validate Design]
